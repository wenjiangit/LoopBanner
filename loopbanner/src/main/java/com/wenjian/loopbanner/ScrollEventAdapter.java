...
final class ScrollEventAdapter extends RecyclerView.OnScrollListener {
    ...
    private final @NonNull RecyclerView mViewPager;
    ...
    ScrollEventAdapter(@NonNull RecyclerView viewPager) {
        mLayoutManager = (LinearLayoutManager) viewPager.getLayoutManager();
    ...
    public void onScrolled(@NonNull RecyclerView recyclerView, int dx, int dy) {
        ...
        if (mDispatchSelected) {
            ...
            mDispatchSelected = false;
            boolean scrollingForward = dy > 0 || (dy == 0 && dx < 0 );
